...
//        [self addSubview:bottomBar];
        ...
        CustomSegmentedControl* csc = [[CustomSegmentedControl alloc] initWithSegmentCount:1 segmentsize:CGSizeMake(48, bottomRealHeight) dividerImage:nil tag:-1 delegate:self];
