...
@property (strong, nonatomic) MJPhoto *currentPhoto;
...
//    [self.view addSubview:self.opButton];
}
...
//        _opButton = [UIButton buttonWithType:UIButtonTypeCustom];
//        _opButton.frame = CGRectMake(kFrame_Width - 60, kFrame_Height - 45, 27, 21);
//        [_opButton setBackgroundImage:[UIImage imageNamed:@"moreOperation.png"] forState:UIControlStateNormal];
//        [_opButton addTarget:self action:@selector(moreOperation) forControlEvents:UIControlEventTouchUpInside];
//    }
//    return _opButton;
//}
...
//{
//    if (HHIOS7) {
//        UIActionSheet *actionSheet = [[UIActionSheet alloc]initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"转发",@"保存到手机", nil];
//        actionSheet.tag = 200;
//        [actionSheet showInView:self.view];
//    }else{
//        UIAlertController *ac = [UIAlertController alertControllerWithTitle:nil message:nil preferredStyle:UIAlertControllerStyleActionSheet];
//        [ac addAction:[UIAlertAction actionWithTitle:@"转发" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
//            [self actionSheet:nil clickedButtonAtIndex:0];
//        }]];
//        [ac addAction:[UIAlertAction actionWithTitle:@"保存到手机" style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
{
    if (_delegate && [_delegate respondsToSelector:@selector(photoBrowser:photo:atIndex:)]) {
        [_delegate photoBrowser:self photo:self.currentPhoto atIndex:buttonIndex];
    }
...
- (void)photoViewImageFinishLoad:(MJPhotoView *)photoView
{
    ...
    self.currentPhoto = photoView.photo;
}
